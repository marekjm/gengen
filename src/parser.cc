...
static const yytype_uint8 yyprhs[] =
{
      ...
      19,    21,    25,    31,    42,    44,    50,    56,    60,    66,
      72,    74,    76,    80,    84,    86,    90,    92,    96,    98,
     100,   102,   106
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      32,    -1,    33,    -1,    35,    -1,    29,    -1,    -1,     3,
      -1,    20,     4,    20,    -1,    20,     4,    21,    10,    20,
      -1,    20,     4,    21,    10,    22,    34,    23,    11,    24,
      20,    -1,     5,    -1,    12,    37,    13,    31,    16,    -1,
      12,    37,    13,    31,    36,    -1,    14,    31,    16,    -1,
      15,    37,    13,    31,    16,    -1,    15,    37,    13,    31,
      36,    -1,    38,    -1,    39,    -1,    38,    17,    39,    -1,
      38,    18,    39,    -1,    40,    -1,    39,     6,    40,    -1,
       4,    -1,     4,    21,    10,    -1,     7,    -1,     8,    -1,
       9,    -1,    25,    37,    26,    -1,    19,    37,    -1
};
...
{
  "$end", "error", "$undefined", "NORMAL_T", "IDE_T", "ITERATION_T",
  "RELOP", "STRING_CONST", "NUM_CONST", "BOOL_CONST", "SKELITEMTYPE_T",
  "OPTVAL_T", "IF_T", "THEN_T", "ELSE_T", "ELSEIF_T", "ENDIF_T", "AND_T",
  "OR_T", "NOT_T", "'@'", "':'", "'{'", "'='", "'}'", "'('", "')'",
  "$accept", "prog", "text", "possibletext", "iftext", "normaltext",
  "substvar", "option_name", "ifstruct", "elsestruct", "expression",
  "boolexp", "relexp", "baseexp", 0
};
#endif
...
{
       0,    10,     0,     0,     0,     2,     3,     5,     6,     7,
      26,    28,    29,    30,     0,     0,     0,    20,    21,    24,
       0,     1,     4,     0,    32,     0,     9,     0,     0,     0,
      11,     0,    27,    31,     8,     0,    22,    23,    25,     0,
       9,     0,    15,    16,    12,     0,     0,     0,    14,     0,
      17,     9,     0,     0,     0,    18,    19,     0,    13
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,    34,     6,    35,     7,     8,    49,     9,    43,
      16,    17,    18,    19
};
...
{
       1,   -36,    -1,    16,     9,     1,   -36,   -36,   -36,   -36,
      12,   -36,   -36,   -36,    -1,    -1,    19,     5,    28,   -36,
      -6,   -36,   -36,    25,   -36,    10,     1,    -1,    -1,    -1,
     -36,    27,   -36,   -36,     1,    -4,    28,    28,   -36,    -3,
       1,    -1,   -36,   -36,   -36,    33,    23,    29,   -36,    17,
     -36,     1,    30,    11,    20,   -36,   -36,    26,   -36
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -36,   -36,    43,    -5,   -35,   -36,   -36,   -36,   -36,    -8,
     -13,   -36,     3,    18
};
...
{
      22,    24,    25,    10,     1,    46,    11,    12,    13,    21,
      40,    41,    42,     2,    30,    31,    53,    44,    14,    45,
      20,     3,    27,    28,    15,    40,    41,    55,    47,    22,
      36,    37,    26,    23,    29,    32,    33,    39,    48,    50,
      52,    54,    51,     5,    57,    56,    58,    38
};

static const yytype_uint8 yycheck[] =
{
       5,    14,    15,     4,     3,    40,     7,     8,     9,     0,
      14,    15,    16,    12,    20,    21,    51,    20,    19,    22,
       4,    20,    17,    18,    25,    14,    15,    16,    41,    34,
      27,    28,    13,    21,     6,    10,    26,    10,     5,    16,
      23,    11,    13,     0,    24,    53,    20,    29
};
...
{
       0,     3,    12,    20,    28,    29,    30,    32,    33,    35,
       4,     7,     8,     9,    19,    25,    37,    38,    39,    40,
       4,     0,    30,    21,    37,    37,    13,    17,    18,     6,
      20,    21,    10,    26,    29,    31,    39,    39,    40,    10,
      14,    15,    16,    36,    20,    22,    31,    37,     5,    34,
      16,    13,    23,    31,    11,    16,    36,    24,    20
};
...
#line 132 "../../src/parser.yy"
    {
             ...
             (yyval.varitem)->setInfo((yylsp[(2) - (3)]).first_line);
           }
    break;
...
#line 138 "../../src/parser.yy"
    {
             ...
             (yyval.varitem)->setInfo((yylsp[(2) - (5)]).first_line);
           }
    break;
...
#line 144 "../../src/parser.yy"
    {
             ...
             options.iteration = (yyvsp[(8) - (10)].boolean);
             (yyval.varitem) = skel_factory->createVarItem ((yyvsp[(2) - (10)].string), (yyvsp[(4) - (10)].string), options);
             (yyval.varitem)->setInfo((yylsp[(2) - (10)]).first_line);
           }
    break;
...
#line 196 "../../src/parser.yy"
    {
               ...
               (yyval.expression)->setInfo((yylsp[(1) - (1)]).first_line);
          }
    break;
...
#line 202 "../../src/parser.yy"
    {
               ...
               (yyval.expression)->setInfo((yylsp[(1) - (3)]).first_line);
          }
    break;
