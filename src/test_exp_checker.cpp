...
main()
{
  ...
  res += assertTrue(isEqualOp("="), "not equal"); 
  res += assertTrue(!isBooleanOp("="), "not boolean ="); 
  res += assertTrue(isEqualOp(std::string("=")), "not equal"); 
  res += assertTrue(!isBooleanOp(std::string("=")), "not boolean ="); 
